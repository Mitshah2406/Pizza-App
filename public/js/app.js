...
var hiddenStatus = document.querySelector('#hiddenInput');
var orderDetails = hiddenStatus ? hiddenStatus.value : null;
...
if (orderDetails) {
  socket.emit('join', "order_".concat(orderDetails._id));
}

var adminAreaPath = window.location.pathname; // get the url eg - (/admin/orders)
...
socket.on('orderUpdated', function (data) {
  var updatedOrder = _objectSpread({}, orderDetails); // ... for copying an object
